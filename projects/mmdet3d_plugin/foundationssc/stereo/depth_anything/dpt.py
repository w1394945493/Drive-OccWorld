...
def _make_dinov2_model(
    ...
    **kwargs,
    ...
    if pretrained:
        raise ValueError("请由外层加载完整 FoundationStereo checkpoint，不单独加载 DINO 权重")
...
class DPT_DINOv2(nn.Module):
    def __init__(
        ...
        self.pretrained = _make_dinov2_model(
            arch_name=arch_name_mapping[encoder], patch_size=14, pretrained=False
