...
from .nuscenes_world_dataset_template_offline import NuScenesWorldDatasetTemplateOffline


@DATASETS.register_module()
class NuScenesWorldDatasetV1Offline(NuScenesWorldDatasetTemplateOffline):
