...
occ_path = "/c20250502/wangyushen/Datasets/nuScenes-Occupancy-v0.1"
use_fine_occ = True
...
dataset_type = 'NuScenesWorldDatasetV1Offline'
...
data = dict(
    ...
    train=dict(
        ...
        ann_file="/c20250502/wangyushen/Weights/drive-occworld/nuscenes_infos_temporal_train_new_v2.pkl",
    ...
    val=dict(
        ...
        data_root=data_root,
        can_bus_root=can_bus_root,
        ann_file="/c20250502/wangyushen/Weights/drive-occworld/nuscenes_infos_temporal_val_new_v2.pkl",
